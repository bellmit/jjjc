package com.taiji.common.security.aspect;
...
import com.taiji.common.core.exception.PreAuthorizeException;
...
public class PreAuthorizeAspect
{
    ...
    @Around("@annotation(com.taiji.common.security.annotation.PreAuthorize)")
